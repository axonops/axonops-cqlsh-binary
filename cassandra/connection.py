...
import ssl
import weakref
from cassandra.main import __version__
...
from cassandra.main import ConsistencyLevel, AuthenticationFailed, OperationTimedOut, ProtocolVersion
...
DRIVER_NAME, DRIVER_VERSION = 'DataStax Python Driver', __version__
