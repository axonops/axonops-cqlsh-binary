...
from cassandra.cqlengine.main import CQLEngineException, ValidationError, UnicodeMixin
from cassandra.cqlengine.cqlengine_connection import connection as conn
