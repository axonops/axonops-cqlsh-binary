...
from cassandra.main import ProtocolVersion
from cassandra.main import DriverException
from cassandra.main import (Unavailable, WriteTimeout, ReadTimeout,
...
from cassandra.main import WriteType
from cassandra.cython_deps import HAVE_CYTHON, HAVE_NUMPY
import cassandra.util as util
from cassandra.type_codes import TYPE_CODES
...
class ResultMessage(_MessageType):
    ...
    type_codes = _cqltypes_by_code = {code: globals()[name] for code, name in TYPE_CODES.items() if name in globals()}
